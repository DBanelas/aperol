...
/**
 * Performs simulations on the fly to estimate the cost of a given plan.
 */
public class SimulationPlanCostEstimator implements PlanCostEstimatorInterface {
    ...
    public SimulationPlanCostEstimator() {
    }
    ...
    /**
     * Method to generate a placement map from the signature of the graph
