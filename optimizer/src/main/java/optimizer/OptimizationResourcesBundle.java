...
public class OptimizationResourcesBundle {
    ...
    private HashMap<String, Double> pairLinks;
    ...
    public void setPairLinks(HashMap<String, Double> pairLinks) {
        this.pairLinks = pairLinks;
    }

    public HashMap<String, Double> getPairLinks() { return this.pairLinks; }
    ...
    public String getDistributionsDirectory() {
        return this.distributionsDirectory;
    }
    ...
    public OperatorCostEstimatorInterface getCostEstimator() {
        return costEstimator;
    }

    public void setCostEstimator(OperatorCostEstimatorInterface costEstimator) {
    ...
    public static class Builder {
        ...
        public Builder withDistributionsDirectory(String distributionsDirectory) {
            this.bundle.setDistributionsDirectory(distributionsDirectory);
            return this;
        }
        ...
        public Builder withCostEstimator(OperatorCostEstimatorInterface costEstimator) {
